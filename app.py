...
<style>
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  .card {
    ...
    width: 520px;
    max-width: 95vw;
    box-shadow: 0 0 0 1px rgba(0,229,255,0.05), 0 24px 64px rgba(0,0,0,0.5);
  ...
  .info-value.purple    { color: var(--accent2); }
...
<div class="card">
  ...
  <div class="info-grid">
    ...
    <div class="info-row">
      <div class="icon">🔗</div>
      <div class="info-content">
        <div class="info-label">Task IP Address</div>
...
def home():
    ...
    try:
        task_ip = socket.gethostbyname(hostname)
    except:
        task_ip = "unavailable"
